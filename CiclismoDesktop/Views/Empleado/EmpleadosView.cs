...
namespace CiclismoDesktopPorCodigo.Views
{
    public partial class EmpleadosView : Form
    {
        ...
        {
            NewEditEmpleadosView nuevoEditarEmpleadosView = new NewEditEmpleadosView();
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            NewEditEmpleadosView nuevoEditarEmpleadosView = new NewEditEmpleadosView(idEmpleadoEdit);
            nuevoEditarEmpleadosView .ShowDialog();
            CargarDatosAGrilla();
        }
    }
